...
def test_calc_all_quarter() -> None:
    ...
    right_res = [(0, 0, color_def), (0, 0, color_def), (0, 0, color_def), (0, 0, color_def)]
    ...
    right_res = [(100, 100, color_def), (100, 100, color_def), (100, 100, color_def), (100, 100, color_def)]
    ...
    right_res = [(50, 10, color_def), (50, 10, color_def), (50, 10, color_def), (50, 10, color_def)]
    ...
    right_res = [(10, -20, color_def), (-10, -20, color_def), (-10, 20, color_def), (10, 20, color_def)]
    ...
    right_res = [(110, 30, color_def), (90, 30, color_def), (90, 70, color_def), (110, 70, color_def)]
